            ...
            <div className="max-w-6xl mx-auto grid grid-cols-12 gap-6">
                ...
                <aside className="col-span-12 lg:col-span-5 bg-[#212329] rounded-2xl p-5 border border-[#8F4AE3]">
                    ...
                    <div className='w-full flex items-center justify-between'>
                        ...
                        <Link href='/dashboard/tasks' className="w-fit px-5 py-2 bg-[#8F4AE3] hover:bg-[#7A3ED1] rounded-lg text-sm cursor-pointer">
                            Earn Points
                        </Link>
                        <button className="w-fit px-5 py-2 bg-red-600 hover:bg-red-600/90 rounded-lg text-sm cursor-pointer">
                            Sign out
                        </button>
                    </div>
                </aside>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {['Full Name', 'Email Address', 'Phone Number'].map((label, i) => (
                                <input
                                    ...
                                    className={`bg-[#16181B] rounded-lg px-4 py-2 text-sm focus:outline-none ${label === 'Email Address'
