...
function Sessions() {
    ...
    const { filteredSessions,
        ...
        setStatus,
        service,
        setService, statusOptions,
        serviceOptions, } = useAdminData()
                ...
                {loading ? (
                    ...
                    <div className="bg-[#212329] border border-gray-800 rounded-2xl p-4 md:p-6 shadow-lg overflow-x-auto">
                        ...
                        <div className="divide-y divide-gray-800">
                            {filteredSessions.length <= 0 ? <section className='flex flex-col items-center justify-center my-6'>
                                ...
                                <p className="text-sm text-gray-400 text-center max-w-xs mb-8">
                                    ...
                                    earn Trust Points.
                                </p></section> : filteredSessions.map((session) => {
